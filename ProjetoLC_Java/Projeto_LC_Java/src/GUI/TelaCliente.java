...
public class TelaCliente extends javax.swing.JFrame {
    ...
    private static TelaCliente instanceTelaCliente;
    public static TelaCliente getInstance(){
        if(instanceTelaCliente==null){
            instanceTelaCliente = new TelaCliente();
    ...
    private void jbProcurarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbProcurarActionPerformed
        String consulta = "";
        try {
            Fachada.getInstance().consultarCliente(consulta);
        } catch (ClienteNaoEncontradoException ex) {
            Logger.getLogger(TelaCliente.class.getName()).log(Level.SEVERE, null, ex);
        }
        try {
            Fachada.getInstance().consultarClienteJ(consulta);
        } catch (ClienteNaoEncontradoException ex) {
            Logger.getLogger(TelaCliente.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void JBDeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBDeletarActionPerformed
       // TODO add your handling code here:
        ...
        if(deletar.length()<13){
            try {
            Fachada.getInstance().removerClienteJ(jtCpfCnpj.getText());
        } catch (ClienteNaoEncontradoException ex) {
            Logger.getLogger(TelaCliente.class.getName()).log(Level.SEVERE, null, ex);
        }
            ...
            try {
            Fachada.getInstance().removerCliente(deletar);
        } catch (ClienteNaoEncontradoException ex) {
            Logger.getLogger(TelaCliente.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void JBModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBModificarActionPerformed
        ...
        //modificar =
        if (modificar.length()<13){
            Fachada.getInstance().atualizarCliente(modificar);
        }
        else{
            try {
                Fachada.getInstance().atualizarClienteJ(jur);
            } catch (ClienteNaoEncontradoException ex) {
                Logger.getLogger(TelaCliente.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
